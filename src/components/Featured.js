...
export default class Featured extends Component {
  ...
  componentDidMount() {
    fetch("https://api.bestbuy.com/v1/products(onSale=true&(categoryPath.id=abcat0501000))?apiKey=" + apiKey +  "&sort=dollarSavings.asc&show=name,url,dollarSavings,salePrice,shortDescription,image,sku&facet=bestSellingRank&pageSize=8&format=json")
  ...
  render() {
    ...
    return (
      <div className='grey-background mt-5 pt-5 pb-5'>
        <div className="container">
          <h3 className="h3 text-center">Top computers on sale</h3>
